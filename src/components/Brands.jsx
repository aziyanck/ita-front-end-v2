    ...
    return (
        <div className="snap-start w-full h-[auto]  text-center dark-text-s light-text-s ">
            <div className="flex flex-col justify-center items-center w-full">
                <h1 data-aos="fade-down" className="text-2xl poppins-extrabold">Our Trusted Brands</h1>

                <div className="m-4 flex flex-col w-full bg-blue-200 group-[.dark-mode]:bg-blue-950 justify-center items-center">
                    <h1 data-aos="fade-up" data-aos-delay="100" className="mt-4 text-lg">The Smartest Home Work Together</h1>
